          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Employee Salary Details</h6>
              </div>
            </div>
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-sm font-weight-bolder ps-2">Month</th>
                      <th class="text-uppercase text-secondary text-sm font-weight-bolder ps-2">Amount</th>
                      <th class="text-center text-uppercase text-secondary text-sm font-weight-bolder">Date</th>
                      ...
                      <td>
                        <div class="d-flex px-2 py-1">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-md">{{salary.name}}</h6>
                          </div>
                        </div>
                      </td>
                      <td>
                        <p class="text-sm font-weight-bold mb-0">{{salary.salary_month}}</p>
                      </td>
                      <td>
                        <p class="text-sm font-weight-bold mb-0">{{salary.amount}}</p>
                      </td>
                      <td class="align-middle text-center text-sm">
                        <p class="text-sm font-weight-bold mb-0">{{salary.salary_date}}</p>
                      </td>
