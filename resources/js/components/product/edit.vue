<template>
 <div>
    ...
    <div class="text-center">
      <h1 class="h4 text-gray-900">Update Product</h1>
    </div>		
		<div class="row">
			<div class="col-md-12">
				<div class="card">
            ...
            <div class="col-md-6">
                      ...
                      <div class="input-group input-group-outline">
                         <select class="form-control" v-model="form.brand_name" required aria-label="Select your option">
            ...
            <h4>Shipping Configuration</h4>
              ...
              <!-- <small class="text-danger" v-if="errors.product_name">{{errors.product_name[0]}}</small> -->
                ...
                <!-- <small class="text-danger" v-if="errors.refundable">{{errors.refundable[0]}}</small> -->
					  </div>
					  <div class="col-md-6">
                <div class="form-check form-switch">
          ...
          <div class="row mt-3">
            <h4>Product Images</h4>
                      ...
                      <small class="text-danger" v-if="errors.new_thumbnail_image">{{errors.new_thumbnail_image[0]}}</small>
					  </div>
					  <div class="col-md-6">
					    <label for="formFileMultiple" class="form-label">Choose Product Images</label>
                      <div class="input-group input-group-outline">
                         <input class="form-control" type="file" id="formFileMultiple" multiple @change="onMultiFileSelected">
                      </div>
                      <small class="text-danger" v-if="errors.new_photos">{{errors.new_photos[0]}}</small>
					  </div>
					</div> 
          ...
          <div class="row mt-4">
            <h4>Product Variation</h4>
					  <div class="col-md-6">
					    <label >Colors</label>
                      <div class="input-group input-group-outline">
                         <select class="form-control" multiple v-model="form.product_color" required aria-label="Select your option">
...
<script type="text/javascript">
  ...
  methods:{
    ...
    onFileSelected(event){
     ...
     if (file.size > 1048770) {
      ...
      reader.onload = event =>{
        this.form.new_thumbnail_image = event.target.result
      };
    ...
    toBase64(file) {
     ...
     async toBase64Handler(filesLists) {
      ...
      this.form.new_photos = mappedFiles;
    },
  ...
  created(){
     let id = this.$route.params.id
        ...
        .then(({data}) => { 
          this.form = data[0];
          this.form.product_color = JSON.parse(data[0].product_color);
          this.form.attribute_name = data[0].product_attribute;
          console.log(this.form.attribute_name);
          this.getAttributeValue();
          this.form.free_shipping = !data[0].free_shipping;
          this.form.product_attribute_value = JSON.parse(data[0].product_attribute_value);
          })
