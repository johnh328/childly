<template>
    ...
    <div class="text-center">
      <h1 class="h4 text-gray-900">Update Baby of {{form.parent_name}}</h1>
    </div>		
		<div class="row">
			<div class="col-md-12">
				<div class="card">
					...
					<form @submit.prevent="babyUpdate" enctype="multipart/form-data">
            <div class="row">
					  <div class="col-md-6">
          ...
          <div class="form-group mt-5">
              <button type="submit" class="btn btn-primary btn-block">Update Baby</button>
            </div>
					</form>
					</div>
          </div>
...
<script type="text/javascript">
  ...
  export default {
    ...
    methods:{
        babyUpdate(){
          let id = this.$route.params.id
          axios.patch('/api/baby/'+id,this.form)
          .then(() => {
            this.$router.push({name:'baby',params:id});
